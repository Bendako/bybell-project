...
export default function Home() {
  ...
  return (
    <div className="min-h-screen pt-10 flex items-center flex-col">
        <h1 className="font-bold">בראשית</h1>
        <div className="w-96">
        <a href="#" className="text-gray-800 bg-gray-100 hover:bg-gray-200">
